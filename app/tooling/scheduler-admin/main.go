// This program performs administrative tasks for the scheduler service.
package main
...
import (
	...
	"github.com/duexcoast/skedjuler/app/tooling/scheduler-admin/commands"
...
type config struct {
	...
	DB   struct {
		...
		HostPort     string `conf:"default:localhost:5432"`

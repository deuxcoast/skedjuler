...
export default function SetupSchedulesCard() {
  ...
  const subHeaderLabel =
    "If you manage multiple schedules separately, give names to those schedules here. For example, if you create separate schedules for Servers and Bussers, we can create those schedules now.";
  return (
